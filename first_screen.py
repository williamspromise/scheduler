...
def main():
    ...
    edu_rbtn = Radiobutton(f1, text="EDU", padx=20,
                            variable=v, value=1).pack(anchor=W)
    edf_rbtn = Radiobutton(f1, text="EDF", padx=20,
                           variable=v, value=2).pack(anchor=W)
    ce_rbtn = Radiobutton(f1, text="Cyclic Executive", padx=20,
                            variable=v, value=3).pack(anchor=W)
    rm_rbtn = Radiobutton(f1, text="Rate Monotonic",
